...
class LocalScriptToolAgent(BaseToolAgent):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.description = (
            ...
            "- Market_metric_node\n"
            "- Market_metric_service\n"
            "- Market_metric_container\n"            
            "- Market_metric_mesh\n"
            "- Market_metric_runtime\n"            
            "- Market_trace\n"
            "- Market_log\n"
            "- Market_cluster_window\n"
            "Market_metric_node, Market_metric_service, Market_metric_container, Market_metric_mesh, and Market_metric_runtime require parameters: date_offline, date_offline_start_ts, date_offline_end_ts,date_online, date_online_start_ts, date_online_end_ts, method, output_folder_name, output_suffix, data_dir, metric_type, and cloudbed."
            "Market_trace and Market_log require parameters: date_offline, date_offline_start_ts, date_offline_end_ts,date_online, date_online_start_ts, date_online_end_ts, method, output_folder_name, output_suffix, data_dir, and cloudbed."
            "Market_cluster_window requires parameters: date_online, output_folder_name, output_suffix."
        )
    ...
    def step(
        ...
        cloudbed: str,        
        date_offline: str,
        date_offline_start_ts: int,
        date_offline_end_ts: int,
        date_online: str,
        date_online_start_ts: int,
        date_online_end_ts: int,
        method: str = "TranAD",
        data_dir: str = "data2",
        ...
        **kwargs: Any,
        ...
        valid_pipelines = {
            "Market_metric_node": "9.run_pipline_Market_metric.py",
            "Market_metric_service": "9.run_pipline_Market_metric.py",
            "Market_metric_container": "9.run_pipline_Market_metric.py",
            "Market_metric_mesh": "9.run_pipline_Market_metric.py",
            "Market_metric_runtime": "9.run_pipline_Market_metric.py",
            "Market_trace": "12.run_pipline_Market_trace.py",
            "Market_log": "14.run_pipline_Market_log.py",
        ...
        for p_type in pipeline_list:
            ...
            # 构建命令行参数
            if p_type == "Market_cluster_window":
                cmd = [
            ...
            elif p_type == "Market_metric_node" or p_type == "Market_metric_service" or p_type == "Market_metric_container" or p_type == "Market_metric_mesh" or p_type == "Market_metric_runtime":
                metric_type = p_type.split("_")[-1].lower()
                cmd = [
                    "/root/shared-nvme/.conda/envs/OmniTransfer_py3.7/bin/python", script_path,
                    "--date_offline", date_offline,
                    "--date_online", date_online,
                    "--date_offline_start_ts", str(date_offline_start_ts),
                    "--date_offline_end_ts", str(date_offline_end_ts),
                    "--date_online_start_ts", str(date_online_start_ts),
                    "--date_online_end_ts", str(date_online_end_ts),
                    "--cloudbed", cloudbed,
                    "--method", method,
                    "--output_folder_name", output_folder_name,
                    "--output_suffix", output_suffix,
