...
class LocalScriptToolAgent(BaseToolAgent):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.description = (
            ...
            "- Bank_trace\n"
            "- Bank_log\n"
            "Each requires parameters: date_offline, date_online, start_ts, end_ts, method, output_folder_name, output_suffix."
        )
    ...
    def step(
        ...
        **kwargs: Any,
        ...
        results = []
        base_output_dir = os.path.join(self.script_dir, output_folder_name)
