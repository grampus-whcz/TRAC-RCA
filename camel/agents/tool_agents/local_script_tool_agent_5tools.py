...
class LocalScriptToolAgent(BaseToolAgent):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.description = (
            ...
            "- Bank_log\n"
            "- Bank_cluster_window\n"
            "Bank_metric_container, Bank_metric_app, Bank_trace, and Bank_log require parameters: date_offline, date_online, start_ts, end_ts, method, output_folder_name, output_suffix. Bank_cluster_window require parameters: date_online, output_folder_name, output_suffix."
        )
    ...
    def step(
        ...
        end_ts: int,
        method: str = "TranAD",
        output_folder_name: str = "default",
        ...
        for p_type in pipeline_list:
            ...
            try:
                ...
                if result.returncode == 0:
                    ...
                    err_detail = f"[{p_type}] Execution failed.\nStderr:\n{result.stderr}\nStdout:\n{result.stdout}"
